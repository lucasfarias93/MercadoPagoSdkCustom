...
public class CheckoutExampleActivity extends AppCompatActivity {
    ...
    private void startMercadoPagoCheckout() {
        new MercadoPagoCheckout.Builder()
                ...
                .setDecorationPreference(createCustomDecorationPreference())
                .startForPayment();
    }

    public DecorationPreference createCustomDecorationPreference(){
        ...
        decorationPreference.setBaseColor("#317ce3");
        //También puedes habilitar la fuente oscura
        //                decorationPreference.enableDarkFont();
        return decorationPreference.build();
    }
